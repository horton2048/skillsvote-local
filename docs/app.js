...
(function () {
  ...
  const I18N = {
    en: {
      ...
      'cta.copy': 'Copy',
      'cta.alt': 'After PyPI release: <code>uvx skillsvote</code> · or <code>pipx run skillsvote</code>',
    ...
    zh: {
      ...
      'cta.cmd': 'uvx --from "https://github.com/horton2048/skillsvote-local/releases/download/v0.2.1/skillsvote-0.2.1-py3-none-any.whl" skillsvote',
      'cta.copy': '复制',
      'cta.alt': 'PyPI 发布后:<code>uvx skillsvote</code> · 或 <code>pipx run skillsvote</code>',
