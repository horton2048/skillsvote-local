...
TB_PRO_SEARCH_OFFLINE_CONFIG="scripts/configs/tb_pro/codex/gpt_5_5/search_offline_evolve_task_48_agg_4_ep_1.yaml"
TB2_SEARCH_CONFIG="scripts/configs/tb2/codex/gpt_5_5/search_seed_tb_pro_search_offline_evolve_task_48_agg_4_ep_1.yaml"
SEED_SKILLS_DIR=".skills_vote/gpt_5_5_xhigh_tb_pro_search_offline_evolve_task_48_agg_4_ep_1"

RUN_TIMESTAMP="${RUN_TIMESTAMP:-$(date +%Y-%m-%d__%H-%M-%S)}"
TB_PRO_SEARCH_OFFLINE_JOB_NAME="tb_pro_codex_gpt_5_5_xhigh_search_offline_evolve_task_48_agg_4_ep_1__${RUN_TIMESTAMP}"
...
TB2_SEARCH_SESSION_NAME="tb2_gpt_5_5_xhigh_search_seed_tb_pro_search_offline_evolve_task_48_agg_4_ep_1_${RUN_TIMESTAMP}"
TB2_SEARCH_JOB_NAME="tb2_codex_gpt_5_5_xhigh_search_seed_tb_pro_search_offline_evolve_task_48_agg_4_ep_1__${RUN_TIMESTAMP}"

echo "Running tb_pro gpt-5.5 xhigh search offline evolve: ${TB_PRO_SEARCH_OFFLINE_JOB_NAME}"
...
echo "Publishing tb_pro gpt-5.5 xhigh search working_skills to seed dir: ${SEED_SKILLS_DIR}"
